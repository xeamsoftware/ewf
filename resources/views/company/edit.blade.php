                            ...
                            <div class="card-body pb-2">
                                ...
                                <div class="row row-sm">
                                    <div class="col-lg">
                                        ...
                                        <input type="text" name="incorporation" value="{{ $id->incorporation }}" class="form-control mb-4 @error('incorporation') is-invalid @enderror" placeholder="incorporation">
                                    ...
                                    <div class="row row-sm">
                                        <div class="col-lg">
                                            ...
                                            <input type="text" name="phone" value="{{ $id->phone }}" class="phone-format form-control mb-4 @error('phone') is-invalid @enderror" placeholder="Enter Federal Tax">
                                            @if ($errors->has('phone'))
                                    ...
                                    <div class="row row-sm">
                                        ...
                                        <div class="col-lg mg-t-10 mg-lg-t-0">
                                            ...
                                            <input type="text" name="account_phone" value="{{ $id->account_phone }}" class="phone-format form-control mb-4 @error('account_phone') is-invalid @enderror" placeholder="Enter Account Phone No">
                                    ...
                                    <div class="row row-sm">
                                        ...
                                        <div class="col-lg mg-t-10 mg-lg-t-0">
                                            ...
                                            <input type="text" name="sales_phone" value="{{ $id->sales_phone }}" class="phone-format form-control mb-4 @error('sales_phone') is-invalid @enderror" placeholder="Enter Sales Phone No">
