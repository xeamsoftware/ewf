            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Agents/Lists</h3>
                            ...
                            <table class="table table-bordered text-nowrap border-bottom" id="basic-datatable">
                                ...
                                <tbody class="list-data">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('agent.edit',$list->id) }}" class="btn btn-sm btn-primary" href="#"><i class="fa fa-edit"></i> Edit</a>
                                            <a onclick="return myFunction();" href="{{ route('agent.delete',$list->id) }}" class="btn btn-sm btn-danger" href="#"><i class="fa fa-trash"></i> Delete</a>
                                            <a class="btn btn-sm btn-secondary" href="{{ route('agent.view',$list->id) }}"><i class="fa fa-info-circle"></i> Details</a>
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
